...
size=$(awk '{ printf "%1.f\n",$10}' path/projects/EA_METAL/OUTPUT/GWAS_ea_new_meta_23andme_UKB_UKBnosibsrels.txt  | sort -rn | head -1 )
samplesize=${size%.00}
...
--cf=path/projects/UKB_LDpred/EA_new/INPUT/LD_pred_coord_EA_new_meta_UKB_23andme_nosibsrels \
--ldr=355 \
--ldf=path/projects/UKB_LDpred/EA_new/OUTPUT/EA_new_snp_ld_meta_23andme_UKB_nosibrels \
--N=${samplesize} \
--f=1 \
--out=path/projects/UKB_LDpred/EA_new/INPUT/LD_pred_w_EA_new_meta_23andme_UKB_nosibrels
