...
--ssf-format=STANDARD \
--ssf=path/projects/UKB_LDpred/EA_new/INPUT/EA_new_meta_23andme_UKB_sanssibsplusrels_fastgwa_ldpred_format.txt \
--N=${samplesize} \
--only-hm3 \
--beta \
--max-freq-discrep 1 \
--vbim=path/data/UKB/ref_panel_v2/ukb_ref_panel_30k.bim \
--out=path/projects/UKB_LDpred/EA_new/INPUT/LD_pred_coord_EA_new_meta_UKB_23andme_nosibsrels
